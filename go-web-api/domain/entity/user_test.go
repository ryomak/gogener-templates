...
var (
	userDBTypes = map[string]string{`ID`: `bigint`, `RandID`: `varchar`, `AuthID`: `varchar`, `Nickname`: `varchar`, `LastNameKana`: `varchar`, `Gender`: `enum('male','female','none')`, `BirthDay`: `datetime`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`, `DeletedAt`: `datetime`}
	_           = bytes.MinRead
)
